...
#      encoder_inputs.append(list(reversed(encoder_input + encoder_pad)))
  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights, bucket_id, forward_only):
    ...
    Args:
      ...
      * bucket : which bucket of the model to use.
      * forward_only : wheter to do the backward step or only forward.

    Returns:
      A triple constisting of gradient norm ( or None if we did not do backward),
      average perplexity, and the outputs.

    Raises:
      ValueError: if length of encoder_inputs, decoder_inputs, or target_weights
...
#     print (encoder_inputs[l])
    ...
    # Since our target are decoder inputs shifted by one, we need one more.
